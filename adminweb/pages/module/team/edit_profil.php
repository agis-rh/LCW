					...
					<div class="content-module-main">
									...
									<p>
										...
										<label for="full-width-input">Last Name</label>
                                                                                <input type="text" maxlength="150" value="<?php echo $data['last_name'];?>" name="last" id="full-width-input" class="default-width-input form-control"/>
										<em>Nama belakang.</em>								
									</p>
                                                                        <p>
										...
										<label>Jenis kelamin</label>
                                                                                <?php
                                                                                if($data['gender']=='L') { ?>
                                                                                <label class="alt-label"><input value="L" checked required name="gender" type="radio"/>Laki - Laki</label>
                                                                                ...
                                                                                <label class="alt-label"><input value="P" checked required name="gender" type="radio"/>Perempuan</label>
                                                                                <?php } ?>
                                                                        </p><br>
									<p>
										<label for="textarea">Alamat</label>
                                                                                <textarea rows="5" placeholder="Masukan teks alamat disini......." name="alamat" class="full-width-textarea form-control"><?php echo $data['alamat'];?></textarea>
									</p>
                                                                        <p>
										...
										<em>Format gambar (*.jpg, *.gif, *.png).</em>								
                                                                        ...
                                                                        ?>
                                                                         <p>
										<label for="full-width-input">Gambar profil Sebelumnya</label>
                                                                                <img src="../photos/users/<?php echo $data['image'];?>" width="50%">
										...
										<label for="full-width-input">Level</label>
                                                                                ...
                                                                                if($data['level']=='admin') {
                                                                                    ...
                                                                                    echo "<option selected value='admin'>Administartor </option>";
                                                                                }
                                                                                else {
                                                                                    echo "<option selected value='user'>User </option>";
                                                                                    echo "<option value='admin'>Administartor </option>";
                                                                                }
                                                                                ?>
                                                                                </select>
										<em>Pilih level.</em>								
									...
									<div class="stripe-separator"><!--  --></div>
                                        ...
                                        if($_POST['save']) {
                                            ...
                                            $jam        = date("H:i:s");
                                            if(!empty($file)) {
                                                $get_one    = $fquery->get_one_team($_GET['id_team']);
                                                if($get_one['image']!='') {
                                                unlink("../photos/users/$get_one[image]");
                                                }
                                                    if(move_uploaded_file($file, $ok)) {
                                                        $fquery->add_log_team($id_team1,'Mengubah akun profilnya',$tanggal,$jam);
                                                        $fquery->edit_image_team($first,$last,$username,$profesi,$filename,$email,$gender,$tgl_lahir,$alamat,$no_hp,$level,$aktif,$id_team);
                                                        echo "<script>window.location='admin.php?page=team&aksi=profil&id_team=$id_team';</script>";
                                                    }
                                                    else {
                                                ...
                                                $fquery->add_log_team($id_team1,'Mengubah akun profilnya',$tanggal,$jam);
                                               $fquery->edit_non_team($first,$last,$username,$profesi,$email,$gender,$tgl_lahir,$alamat,$no_hp,$level,$aktif,$id_team);
                                                 echo "<script>window.location='admin.php?page=team&aksi=profil&id_team=$id_team';</script>";
